...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->add_column('action', anchor(site_url('admin/".$c_url."/read/\$1'),'Read').\" | \".anchor(site_url('admin/".$c_url."/update/\$1'),'Update').\" | \".anchor(site_url('admin/".$c_url."/delete/\$1'),'Delete','onclick=\"javasciprt: return confirm(\\'Are You Sure ?\\')\"'), '$pk');
