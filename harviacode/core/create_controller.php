...
$string .= "\n\n    public function index()
    {
        ...
        \$this->template->load('template','admin/$c_url/$v_list', \$data);
    }";
...
$string .= "\n\t    );
            \$this->template->load('template','admin/$c_url/$v_read', \$data);
        } else {
...
$string .= "\n\t);
        \$this->template->load('template','admin/$c_url/$v_form', \$data);
    }
