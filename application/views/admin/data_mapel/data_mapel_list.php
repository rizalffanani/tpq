<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/data_mapel/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/data_mapel/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_mapel",
                            "orderable": false
                        },{"data": "nama_mapel"},{"data": "nama_jenis_mapel"},
                        {
                            "data" : "action",
                            "orderable": false,
