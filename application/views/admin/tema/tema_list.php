<div class="row" style="margin-bottom: 10px">
        ...
        <table class="table table-bordered table-striped" id="mytable">
		    ...
		    <th>Sidebar Bg Color</th>
		    <th>Sidebar Font Color</th>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/tema/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_tema",
                            "orderable": false
                        },{"data": "navbar_bg_color"},{"data": "navbar_font_color"},{"data": "sidebar_bg_color"},{"data": "sidebar_font_color"},
                        {
                            "data" : "action",
                            "orderable": false,
