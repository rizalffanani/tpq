<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/catatan/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/catatan/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_catatan",
                            "orderable": false
                        },{"data": "id_kelas_siswa"},{"data": "kelakuan"},{"data": "kerajinan"},{"data": "kebersihan"},{"data": "izin"},{"data": "sakit"},{"data": "alpa"},{"data": "catatan"},
                        {
                            "data" : "action",
                            "orderable": false,
