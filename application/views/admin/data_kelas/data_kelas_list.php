<div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('admin/data_kelas/create'), 'Create', 'class="btn btn-primary"'); ?>
            </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "<?php echo base_url() ?>admin/data_kelas/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_kelas",
                            "orderable": false
                        },{"data": "nama_kelas"},{"data": "nama_jenjang"},
                        {
                            "data" : "action",
                            "orderable": false,
